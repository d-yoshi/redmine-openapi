...
test("Repositories", async (t) => {
  ...
  await t.test("POST /projects/{project_id}/repository/{repository_id}/revisions/{revision}/issues.json", async () => {
  ...
  await t.test("DELETE /projects/{project_id}/repository/{repository_id}/revisions/{revision}/issues/{issue_id}.json", async () => {
